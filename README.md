...
The training and test data sets of this dataset is the put together into one large data.frame containing all data called **total_df** data.frame in the script.
